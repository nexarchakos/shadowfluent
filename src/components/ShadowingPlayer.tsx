  ...
  if (shouldShowFullscreen) {
    return (
      <div className="fixed inset-0 z-[9999] bg-gradient-to-br from-primary-600 to-primary-800 w-screen h-screen overflow-hidden">
        <div className="w-full h-full grid grid-rows-[min-content_1fr_min-content] justify-items-center gap-3 sm:gap-4 md:gap-6 [@media(max-height:500px)]:gap-2 p-4 md:p-8 pb-36 sm:pb-16 md:pb-10 lg:pb-20 xl:pb-24">
          ...
          {/* Bottom controls */}
          <div className="flex flex-col items-center gap-3 md:gap-6 [@media(max-height:500px)]:gap-2 w-full max-w-3xl px-4 pb-[env(safe-area-inset-bottom)] mx-auto justify-self-center">
